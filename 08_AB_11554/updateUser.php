			...
			<div class="span2"></div>
				<div class="span8">
					<center><h3>UPDATE DATA USER</h3>
						<?php
							$id=$_GET['id'];
							$tmp = mysqli_query($conn, "SELECT * FROM user WHERE id='$id'");
					...
					<form action="updateUser2.php" method="post">
						...
						<tr>
							<td width="152">ID</td>
							<td width="157"><input name="id" type="text" id="id" size="20" value="<?php echo $row['id']; ?>" readonly/></td>
							</tr>
							<td width="152">Username</td>
							<td width="157"><input
							name="username" type="text" id="username" size="20" value="<?php echo $row['username']; ?>" readonly/></td>
							</tr>
							<tr>
							<td>Password</td>
