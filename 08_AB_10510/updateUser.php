					...
					<form action="updateUser2.php" method="post">
						<table width="319" border="0">
							<tr>
								...
								<td width="157"><input name="username" type="text" id="username" size="20"  value = echo $_POST['username'];/></td>
							</tr>
							<tr>
								<td>Password</td>
								<td><input name="password" type="text" id="password" size="20" value="<?php echo $buff['password']; ?>"/></td>
							</tr>
							<tr>
								<td>Level</td>
								<td>
									<select name='level'value="<?php echo $buff['level']; ?>">
